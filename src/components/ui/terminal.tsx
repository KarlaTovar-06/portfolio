...
export function Terminal({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "mx-auto w-full max-w-sm px-4 font-mono text-xs",
        className,
      )}
    >
      <div className="h-[250px] overflow-hidden rounded-lg border border-stone-200/20 bg-background shadow-2xl">
        {/* Title Bar */}
        ...
        <div
          ref={contentRef}
          className="no-visible-scrollbar flex-1 overflow-y-auto p-4 font-mono border border-b-0 border-x-0 border-t-stone-200 dark:border-t-stone-200/20"
        >
          {lines.map((line, i) => (
