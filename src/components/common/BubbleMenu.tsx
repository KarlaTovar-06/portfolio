      ...
      >
        ...
        >
          <span
            className={[
              ...
              "w-[120px] h-full text-foreground",
            ].join(" ")}
          >
            Karla Tovar
          </span>
        ...
        <button
          ...
          className={[
            ...
            "border border-stone-200/20 cursor-pointer p-0",
            "will-change-transform",
          ].join(" ")}
          onClick={handleToggle}
        ...
        >
          ...
          />
          <span
            className="menu-line short block mx-auto rounded-[2px] text-foreground"
            style={{
              marginTop: "6px",
              width: 26,
              height: 2,
